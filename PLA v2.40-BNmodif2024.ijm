...
-----------------------------------------------------------------------------------------------------------------------------------------*/
			...
			print(tableTitle2, nameStore0 + "\t"  + Thresh + "\t"  + brN + "\t"  + btN + "\t"  + drN + "\t"  + dtN + "\t"  + sigN + "\t"  + LowerNuc + "\t" + UpperNuc + "\t"  + lseN + "\t"  + useN + "\t"  + lceN + "\t"  + uceN + "\t"  + watershedN + "\t"  + excludeN + "\t"  + sigF + "\t"  + max + "\t"  + brC + "\t"  + btC + "\t"  + drC + "\t"  + dtC + "\t"  + sigC + "\t"  + LowerCyto + "\t"  + UpperCyto + "\t"  + lseC + "\t"  + useC + "\t"  + lceC + "\t"  + uceC + "\t"  + watershedC + "\t"  + excludeC);	
     // changed to include new results BN2024
				print(tableTitle4, nameStore0 + "\t"  + NucleusCount + "\t"  + NucleiArea + "\t"  + AverageNucleiArea + "\t"  + TotalSignal + "\t" + PercentNuclearSignal  + "\t"+ tNuclearSignal + "\t"  + AverageSignalPerNucleus + "\t"  + tNUC0 + "\t" + percenttNUC0 + "\t"+ tNUC1 + "\t" + percenttNUC1 + "\t"+ tNUCmulti + "\t"+percenttNUCmulti+ "\t"+ averageSignalPertNUCmulti + "\t"+ NonNuclearSignal + "\t" + CytoArea + "\t"  + AverageCytoArea + "\t"  + CytoSignal + "\t"  + NonCytoSignal + "\t"  + PercentCytoSignal + "\t"  + AverageSignalPerCyto + "\t"  + IntracellularSignal + "\t"  + ExtracellularSignal);
	 //end of change
...
-----------------------------------------------------------------------------------------------------------------------------------------*/
			...
			print(tableTitle2, nameStore0 + "\t"  + Thresh + "\t"  + brN + "\t"  + btN + "\t"  + drN + "\t"  + dtN + "\t"  + sigN + "\t"  + LowerNuc + "\t" + UpperNuc + "\t"  + lseN + "\t"  + useN + "\t"  + lceN + "\t"  + uceN + "\t"  + watershedN + "\t"  + excludeN + "\t"  + sigF + "\t"  + max + "\t"  + brC + "\t"  + btC + "\t"  + drC + "\t"  + dtC + "\t"  + sigC + "\t"  + LowerCyto + "\t"  + UpperCyto + "\t"  + lseC + "\t"  + useC + "\t"  + lceC + "\t"  + uceC + "\t"  + watershedC + "\t"  + excludeC);	
    // changed to include new results BN2024
				print(tableTitle4, nameStore0 + "\t"  + NucleusCount + "\t"  + NucleiArea + "\t"  + AverageNucleiArea + "\t"  + TotalSignal + "\t" + tNuclearSignal + "\t" + tNUC0 + "\t" + percenttNUC0 + "\t" + tNUC1 + "\t"+ percenttNUC1 + "\t"+ tNUCmulti + "\t"+ percenttNUCmulti + "\t" + averageSignalPertNUCmulti + "\t"+ NonNuclearSignal + "\t"  + PercentNuclearSignal + "\t"  + AverageSignalPerNucleus + "\t"  + CytoArea + "\t"  + AverageCytoArea + "\t"  + CytoSignal + "\t"  + NonCytoSignal + "\t"  + PercentCytoSignal + "\t"  + AverageSignalPerCyto + "\t"  + IntracellularSignal + "\t"  + ExtracellularSignal);
	//end of change
...
// changed to include new results BN2024
	print(tableTitle4,"\\Headings:Image name\tNucleus Count\tTotal Nuclei Area\tAverage Nuclei Area\tTotal Signal\tPercent Nuclear Signal\ttNuclear Signal\tAverage Signal per Nucleus\ttNucleus 0 Signal\tpercent tNucleus 0\ttNucleus 1 Signal\tpercent tNucleus 1\tNucleus multiple Signals\tpercent tNucleus multiple\tAverage Signal per Nucleus multiple\tNonNuclear Signal\tCytoplasm Area\tAverage Cytoplasmic Area\tCytoplasmic Signal\tNon Cytoplasmic Signal\tPercent Cytoplasmic Signal\tAverage Signal per Cytoplasm\tIntracellular Signal\tExtracellular Signal");
// end of change
    if (cyto == "NoCyto"){
...
-----------------------------------------------------------------------------------------------------------------------------------------*/
			...
			// changed
				...
				for (a=0; a<nResults(); a++) {
				    ...
				    if (SignalperNucleus != 0) {
				             setResult("NUC0", a, 0); 
		                     } else {setResult("NUC0", a, 1);
				             }
	                if (SignalperNucleus != 1) {
				             setResult("NUC1", a, 0); 
				             } else {setResult("NUC1", a, 1);
				             }	
		         //count column tables
		            tNUC0 = tNUC0 + getResult("NUC0", a);
             ...
             tNUCmulti = NucleusCount - tNUC0 - tNUC1;
				...
				if (NucleusCount != 0) {
                percenttNUC0 = (tNUC0/NucleusCount)*100;
				} else {percenttNUC0 = 0;
				}
				if (NucleusCount != 0) {
                percenttNUC1 = (tNUC1/NucleusCount)*100;
				} else {percenttNUC1 = 0;
				}
				if (NucleusCount != 0) {
				...
				if (NucleusCount!=0) {
					AverageSignalPerNucleus = tNuclearSignal/NucleusCount;
				} else{
					AverageSignalPerNucleus = 0;
				}
				if (TotalSignal!=0) {
					PercentNuclearSignal = (tNuclearSignal/TotalSignal)*100;
				} else{
					PercentNuclearSignal = 0;
				}       
        	    } else {
				...
				updateResults(); 
	           	//saveAs("Results", dir+nameStore1+" - results.csv");
			// end of change
				run("Close All");
				if(isOpen("ROI Manager")==1){
				selectWindow("ROI Manager");
